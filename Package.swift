...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ContentsquareInterimBridge",
            url: "https://github.com/ContentSquare/apple-interim-bridge-sdk/releases/download/0.9.0-alpha.1/package.zip",
            checksum: "969fde7bc240eb09b0ebd71f4322da4b00f044f041fb38960c60a88815c251f5"
        ),
    ]
)
